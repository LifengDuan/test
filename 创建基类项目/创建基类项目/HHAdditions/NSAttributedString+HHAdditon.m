//
//  NSAttributedString+HHAdditon.m
//

#import "NSAttributedString+HHAdditon.h"

@implementation NSAttributedString (HHAdditon)

+ (instancetype)hh_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
